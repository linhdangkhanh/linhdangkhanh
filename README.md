...
**Research & ML**  
Computer Vision · Deep Learning · YOLOv8 · Object Tracking · Wireless Sensing · Molecular ML (RDKit, DeepChem)
 
---
 
## 🏆 Highlights
 
- 🥇 **Winner** — Best Use of DigitalOcean @ Hack(H)er413 2026 *(ShareBooth)*
- 🥇 **Winner** — Most Ethical AI Hack @ HackUMASS XIII *(OnePen)*
- 🔬 **Undergraduate Research Assistant** — Wireless Sensing & Systems Lab (WSSL), UMass Amherst
- 🔬 **Summer Researcher** — ML & IoT Lab, Vietnam National University HCMUT
- 🎓 Dean's List
---
...
| Toxicity Prediction | ML pipeline for molecular toxicity using RDKit & ECFP4 | Python, RDKit, scikit-learn |
...
*Open to freelance work in full-stack development and academic research collaboration.*
